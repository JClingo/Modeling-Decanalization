...
Performance differences in phase 1 were minimal, as expected, since the phases were identical. There was a small but significant difference in mean \(h\) and total \(h\) gained. Because the environments were matched, we interpret this as residual stochastic variation in learned behavior rather than as evidence of a systematic phase-1 difference. The other measures did not change significantly, as expected.
...
The phase 3 (recanalization vs. canalization) comparison was critical because it directly compared agents that did or did not undergo a decanalization phase. The agent in the recanalization condition managed mean \(h\) more effectively, relative to \(h^*\), and showed lower setpoint deviation (measured as the standard deviation over all timesteps in the phase) than the no-canalization agent. Reward prediction also increased slightly, although the decanalized agent experienced more loss in \(h\), post-decanalization. This increased loss was offset by greater \(h\) gain through pellet consumption, although pellet diversity did not increase, suggesting that decanalized agents located higher-payout pellets in less-traversed regions.
